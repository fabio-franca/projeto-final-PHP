...
class LoginController extends BaseController
{
    ...
    public function logar()
    {
        ...
        if ($this->request->withMethod("post")) {
            ...
            $validation = array(
                "usuario" => ["rules" => "required", "errors" => ["required" => "Campo usuário é obrigatório"]],
                "senha" => ["rules" => "required", "errors" => ["required" => "Campo senha é obrigatório"]],
            );
            ...
            if ($this->validate($validation)) {
                ...
                if ($usuario = $this->model->where("user_email", $this->request->getVar("usuario"))
                    ...
                    array_push($data['mensagens'], ['tipo' => 'warning', 'descricao' => "usuário ou senha inválidos"]);
                }
            } else {
