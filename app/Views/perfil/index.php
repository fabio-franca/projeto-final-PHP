                  ...
                  <div class="card-body">
                    <div class="tab-content">
                      ...
                      <div class="active tab-pane" id="settings">
                        <form class="form-horizontal" action="<?=base_url();?>/PerfilController/editar" autocomplete="off" method="POST">
                          ...
                          <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                              ...
                              id="inputSkills" placeholder="Preencha caso queira alterar">
                            </div>
                          </div>                          
