    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        ...
        <div class="info">
          ...
          <a href="#" class="d-block"> Olá, <?= isset($_SESSION['sistema'])? $_SESSION['sistema']['usuario'] : '' ?></a>         
        </div>
      </div>
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          <!-- Add icons to the links using the .nav-icon class
            ...
            <li class="nav-item">
              ...
              <span class="iconify" data-icon="bi:box" data-width="23" data-height="23"></span>
                <p>
                  Produtos
              ...
              <ul class="nav nav-treeview">              
                <li class="nav-item">
                  ...
                  <span class="iconify" data-icon="bi-card-list" data-width="23" data-height="23"></span>
                    <p>Listar</p>
                  </a>
                </li>
                ...
                <li class="nav-item">
                  ...
                  <span class="iconify" data-icon="bi:file-earmark-plus-fill" data-width="23" data-height="23"></span>
                    <p>Adicionar</p>
                  </a>
                </li>
              </ul>
            ...
            <li class="nav-item">
              <a href="#" class="nav-link">
              <span class="iconify" data-icon="bi-truck" data-width="23" data-height="23"></span>
                <p>
                  Fornecedores
                  <i class="right fas fa-angle-left"></i>
                </p>
            ...
            <li class="nav-item">
              <a href="#" class="nav-link">
              <span class="iconify" data-icon="bi-file-earmark-person" data-width="23" data-height="23"></span>
                <p>
                  Clientes
                  <i class="right fas fa-angle-left"></i>
                </p>
            ...
            <li class="nav-item">
              <a href="#" class="nav-link">
              <span class="iconify" data-icon="jam:users" data-width="26" data-height="26"></span>
                <p>
                Usuários
                  <i class="right fas fa-angle-left"></i>
                </p>
            ...
            <li class="nav-item"><a href="<?php echo base_url('/dashboard/perfil'); ?>" class="nav-link"><span class="iconify" data-icon="bx:bx-user" data-width="26" data-height="26"></span> <p> Seu Perfil </p></a> </li>
